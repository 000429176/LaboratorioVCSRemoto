# -*- coding: utf-8 -*-
"""
Created on Sun Apr 23 19:16:30 2020
...
def temperatura(presion):
    presionAtm = presion.copy()
    
    for i in range(0, len(presionAtm)):
        presionAtm[i] = presionAtm[i]*1000
        presionAtm[i] = presionAtm[i]/101325
    
    temperatura = []
    
    for element in presionAtm :
        temperature = round(((element*510)/(17.16*0.082)),2)
...
temperatura = temperatura(presion)
print("La temperatura promedio semanal es: " + str(temperatura) + "\n")
